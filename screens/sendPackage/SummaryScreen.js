...
import { db, push, ref, set, update } from "../../utils/firebase";
      ...
      >
        ...
        <View style={{ marginTop: 20 }}>
          ...
          >
            ...
            <View>
              <CustomText style={{ marginBottom: 5 }}>{category}</CustomText>
              <CustomText
                style={{
                  marginBottom: 5,
                  fontSize: 13,
          ...
          >
            ...
            <View>
              <CustomText style={{ marginBottom: 5 }}>{weight}</CustomText>
            </View>
          </View>
